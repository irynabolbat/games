        ...
        <div className={active ? "modal_hints active" : "modal_hints"} onClick={() => setActive(!active)}>
            <div className={active ? "modal_content_hints active" : "modal_content_hints"}
                ...
                <div className="hint_wrapper">
                    ...
                    <img src={rValue.img} className="hint_main_img"/>
                    <p>{t(rValue.text)}</p>
                    <div className="hint_img_container">
                        <img src={rValue.img_1} className="hint_img"/>
                        {rValue.img_2 ? <img src={rValue.img_2} className="hint_img"/> : <></>}
                        {rValue.img_3 ? <img src={rValue.img_3} className="hint_img"/> : <></>}
                        {rValue.img_4 ? <img src={rValue.img_4} className="hint_img"/> : <></>}
                    </div>
                </div>
            </div>
        </div>
